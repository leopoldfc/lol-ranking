/**
 * Scrape Worlds 2025 depuis gol.gg
 * Splits : Play-In + Main Event
 * Combined : Worlds 2025
 * Export → frontend/public/leagues/worlds-2025/export.json
 *
 * Usage : npx tsx leagues/2025/worlds-2025/scrape.ts
 */
...
const SPLITS = [
  { key: 'playin', name: 'Worlds 2025 Play-In',    season: 'ALL' },
  { key: 'main',   name: 'Worlds 2025 Main Event', season: 'ALL' },
];
const COMBINED_NAME = 'Worlds 2025';
...
const exportData = {
  metadata: {
    ...
    tournaments: [{ name: COMBINED_NAME, league: 'International', year: 2025, split: 'Worlds', scrapedAt: new Date().toISOString() }],
  },
...
fs.writeFileSync(path.join(__dirname, '../../../frontend/public/leagues/worlds-2025/export.json'), JSON.stringify(exportData, null, 2));

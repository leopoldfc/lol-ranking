/**
 * Scrape MSI 2025 depuis gol.gg
 * Export → frontend/public/leagues/msi-2025/export.json
 *
 * Usage : npx tsx leagues/2025/msi-2025/scrape.ts
 */
...
const TOURNAMENT  = '2025 Mid-Season Invitational';
const SEASON      = 'ALL';

/**
 * Scrape LCK 2025 depuis gol.gg
 * Splits : Cup + Rounds 1-2 + Road to MSI + Rounds 3-5 + Season Play-In + Season Playoffs
 * Export → frontend/public/leagues/lck-2025/export.json
 *
 * Usage : npx tsx leagues/2025/lck-2025/scrape.ts
 */
...
const SPLITS = [
  { key: 'cup',       name: 'LCK Cup 2025',              season: 'ALL' },
  { key: 'rounds12',  name: 'LCK 2025 Rounds 1-2',       season: 'ALL' },
  { key: 'roadtomsi', name: 'LCK 2025 Road to MSI',      season: 'ALL' },
  { key: 'rounds35',  name: 'LCK 2025 Rounds 3-5',       season: 'ALL' },
  { key: 'playin',    name: 'LCK 2025 Season Play-In',   season: 'ALL' },
  { key: 'playoffs',  name: 'LCK 2025 Season Playoffs',  season: 'ALL' },
];
const COMBINED_NAME = 'LCK 2025';
...
const exportData = {
  metadata: {
    ...
    tournaments: [{ name: COMBINED_NAME, league: 'LCK', year: 2025, split: 'Full Year', scrapedAt: new Date().toISOString() }],
  },
...
fs.writeFileSync(path.join(__dirname, '../../../frontend/public/leagues/lck-2025/export.json'), JSON.stringify(exportData, null, 2));

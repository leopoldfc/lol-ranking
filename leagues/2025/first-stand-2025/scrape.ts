/**
 * Scrape First Stand 2025 depuis gol.gg
 * Export → frontend/public/leagues/first-stand-2025/export.json
 *
 * Usage : npx tsx leagues/2025/first-stand-2025/scrape.ts
 */
...
const TOURNAMENT  = 'First Stand 2025';
const SEASON      = 'ALL';
...
const exportData = {
  metadata: {
    ...
    tournaments: [{ name: TOURNAMENT, league: 'International', year: 2025, split: 'First Stand', scrapedAt: new Date().toISOString() }],
  },
...
fs.writeFileSync(path.join(__dirname, '../../../frontend/public/leagues/first-stand-2025/export.json'), JSON.stringify(exportData, null, 2));
